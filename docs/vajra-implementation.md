...
| Resource | URL |
|----------|-----|
| GitHub Repo | https://github.com/***REMOVED***/vajra-truth-checker |
| Vercel Project | v0-vajra-truth-checker (***REMOVED***s-projects) |
| Supabase | ***REMOVED*** |
...
- Domain: clarusapp.io verified in Resend
