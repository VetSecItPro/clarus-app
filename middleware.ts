...
const CSP_DIRECTIVES = [
  "default-src 'self'",
  // NOTE: 'strict-dynamic' requires per-request nonces on all inline scripts.
  // Next.js 15 injects inline hydration scripts without nonces, so 'strict-dynamic'
  // blocks them and breaks client-side rendering entirely. Keep 'unsafe-inline' with
  // an explicit domain allowlist until nonce infrastructure is implemented.
