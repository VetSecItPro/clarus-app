...
BEGIN
    ...
    SELECT
        ...
        bi.thumbnail_url,
        bi.type,
        bi.date_added as created_at, -- FIX: Use date_added and alias it to created_at
        bi.content_body,
        bi.raw_content,
        bi.date_added,
        bi.model_name,
    ...
    FROM brain_items bi
    WHERE
        bi.content_ratings IS NOT NULL -- This ensures only items with valid ratings are returned
