...
export default function MobileBottomNav() {
  ...
  return (
    <nav aria-label="Mobile navigation" className="fixed left-0 right-0 z-50 bg-black/95 backdrop-blur-2xl border-t border-white/[0.06] rounded-t-2xl sm:hidden fixed-bottom-safe select-none">
