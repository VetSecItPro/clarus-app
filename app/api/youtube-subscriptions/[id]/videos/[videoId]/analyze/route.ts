...
export async function POST(
  ...
  const rateLimit = await checkRateLimit(`yt-analyze:${clientIp}`, 10, 60000) // 10 per minute
  ...
  // Pre-flight usage check — read-only snapshot to avoid wasting transcript/AI
