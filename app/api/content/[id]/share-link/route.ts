...
export async function POST(
  ...
  // SECURITY: FIX-SEC-020 — Token generated by crypto.randomBytes (lib/share-token.ts),
  // providing 72 bits of entropy via 12 base62 chars (~3.2e21 combinations). Safe for
  // unguessable share URLs. Not used for authentication — only public link obfuscation.
