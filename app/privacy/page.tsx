      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
          ...
          <div className="p-4 bg-white/[0.04] border border-white/[0.08] rounded-xl">
            ...
            <p className="text-white/50 text-xs">privacy@infosecops.io</p>
          </div>
        </div>
          ...
          <div className="space-y-8 text-white/70">
            ...
            <section>
              ...
              <p className="leading-relaxed mt-4">
                ...
                <a href="mailto:privacy@infosecops.io" className="text-[#1d9bf0] hover:underline">
                  privacy@infosecops.io
