        ...
        <ChartCard title="Users by Tier">
          <div className="h-[240px]">
            {loading ? (
                    ...
                    return (
                      <div key={t.name} className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          ...
                          <span className="text-xs text-white/50 ml-2">{pct}%</span>
                        </div>
                      </div>
                    )
                  })}
              ...
              <div className="h-full flex items-center justify-center text-sm text-white/50">No user data yet</div>
            )}
          </div>
        </ChartCard>
        ...
        <ChartCard title="Subscription Revenue">
          <div className="space-y-4">
            <div className="text-3xl font-semibold text-white">
              ...
              <span className="text-sm text-white/50 font-normal ml-2">/ month</span>
            </div>
