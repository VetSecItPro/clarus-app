      ...
      <ChartCard title="7-Day Cost Trend">
        <div className="h-[280px]">
          {loading ? (
            ...
            <div className="h-full flex items-center justify-center text-sm text-white/50">Not enough data for trend</div>
          )}
        </div>
      </ChartCard>
        ...
        <ChartCard title="Cost by Service (Today)">
          <div className="h-[260px]">
            {loading ? (
              ...
              <div className="h-full flex items-center justify-center text-sm text-white/50">No API calls today</div>
            )}
          </div>
          {/* Call counts table */}
          {costBreakdown.length > 0 && (
              ...
              {costBreakdown.map((item) => (
                <div key={item.api} className="flex justify-between items-center text-xs py-1">
                  ...
                  <div>
                    ...
                    <span className="text-white/50 ml-2">({item.calls} calls)</span>
                  </div>
                </div>
              ))}
            </div>
        ...
        <ChartCard title="Cost by AI Model (7 Days)">
          <div className="h-[260px]">
            {loading ? (
              ...
              <div className="h-full flex items-center justify-center text-sm text-white/50">No model data yet</div>
            )}
          </div>
          {/* Token usage table */}
          {modelBreakdown.length > 0 && (
