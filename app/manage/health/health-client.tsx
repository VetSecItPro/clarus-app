  ...
  return (
    <div className="space-y-6">
      ...
      <ChartCard title="Service Status">
        ...
        <p className="text-white/50 text-[0.625rem] mt-3">
        ...
        <ChartCard title="Error Rate Trend (7 Days)">
          <div className="h-[220px]">
            {loading ? (
              ...
              <div className="h-full flex items-center justify-center text-sm text-white/50">Not enough data</div>
            )}
          </div>
        </ChartCard>
              ...
              {processingBySection.map((item) => (
                <div key={item.section} className="flex items-center gap-3">
                  ...
                  <div className="text-right w-24 shrink-0">
                    ...
                    <span className="text-xs text-white/50 ml-1">({item.count}x)</span>
                  </div>
                </div>
              ))}
            </div>
          ) : (
            <div className="py-8 text-center text-sm text-white/50">No processing data yet</div>
          )}
        </ChartCard>
      </div>
