          ...
          <div className="space-y-8 text-white/70">
            <section>
              ...
              <p className="leading-relaxed">
                By accessing or using Clarus (&quot;the Service&quot;), you agree to be bound by these Terms of Service.
            ...
            <section>
              ...
              <p className="leading-relaxed">
                Clarus is a content analysis tool that uses artificial intelligence to help users understand
                and extract insights from online content, including articles, videos, and social media posts.
                The Service provides analysis, summaries, key takeaways, and actionable recommendations.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed mb-3">
                The analysis and assessments provided by Clarus are generated by artificial intelligence
            ...
            <section>
              ...
              <p className="leading-relaxed">
                The Service and its original content, features, and functionality are owned by Clarus
            ...
            <section>
              ...
              <p className="leading-relaxed">
                TO THE MAXIMUM EXTENT PERMITTED BY LAW, CLARUS SHALL NOT BE LIABLE FOR ANY INDIRECT,
