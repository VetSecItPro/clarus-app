  ...
  return (
    <div
      className={cn(
        ...
        highlighted
          ? "ring-2 ring-[#1d9bf0]/40 bg-[#1d9bf0]/5 border-[#1d9bf0]/30"
      ...
      <div className="flex items-center gap-3 mb-5">
        <div
          className={cn(
            ...
            highlighted ? "bg-[#1d9bf0]/15" : "bg-white/[0.06]"
          )}
        >
          <Icon
            className={cn(
              "w-5 h-5",
              highlighted ? "text-[#1d9bf0]" : "text-white/60"
            )}
          />
        </div>
        <div>
          ...
          {highlighted && (
            <span className="text-[11px] font-medium text-[#1d9bf0] uppercase tracking-wider">
              Your device
            </span>
          )}
        </div>
      ...
      <ol className="space-y-3">
        {platform.steps.map((step, i) => (
          <li key={i} className="flex items-start gap-3">
            <span className="flex-shrink-0 bg-[#1d9bf0] text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold">
              {i + 1}
            </span>
...
function BenefitCard({ benefit }: { benefit: BenefitInfo }) {
  ...
  return (
    <div className="flex flex-col items-center text-center rounded-xl border border-white/[0.06] bg-white/[0.03] p-6 transition-colors hover:bg-white/[0.05]">
      <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-[#1d9bf0]/10 mb-4">
    ...
    <div className="min-h-screen bg-[#0a0e1a] flex flex-col">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-8 pb-28 sm:pb-8">
        ...
        <section className="text-center pt-10 pb-10 sm:pt-16 sm:pb-14">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#1d9bf0]/10 mb-6">
            <Download className="w-8 h-8 text-[#1d9bf0]" />
          </div>
          ...
          {deferredPrompt && (
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-[#1d9bf0] hover:bg-[#1a8cd8] text-white font-semibold text-sm shadow-lg shadow-[#1d9bf0]/25 hover:shadow-[#1d9bf0]/40 transition-all duration-200 hover:-translate-y-0.5"
            >
